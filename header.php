...
<head>
	...
	<link rel="mask-icon" href="<?php bloginfo('template_url'); ?>/assets/images/favicon.png" color="#5bbad5">
...
<body <?php body_class(); ?>>
	...
	<div id="page" class="site">
		...
		<?php get_template_part('template-parts/layout/header/header', 'primary'); ?>
