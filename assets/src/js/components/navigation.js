...
export function mobileMenu() {
    ...
    if (burger) {
        ...
        document.addEventListener('click', function(event) {
            ...
            else if (siteHeader.classList.contains('menu-open') && !event.target.closest('.site-header__primary-menu')) {
                siteHeader.classList.remove('menu-open');
            }
...
export function menuDrilldown() {
    ...
    if(siteHeader.classList.contains('type-vertical-drilldown')) {
        subMenu.forEach(function(menu) {
            ...
            createdDiv.innerHTML = '<i class="fa-solid fa-angle-left icon-back"></i> Back';
    ...
    document.addEventListener('click', function(event) {
        event.stopPropagation();
        if (!event.target.closest('.site-header__primary-menu') && siteHeader.classList.contains('menu-open')) {
...
export function searchToggle() {
    ...
    if (searchButton) {
        ...
        // eslint-disable-next-line 
        document.addEventListener('click', function(event) {
            if (searchForm && !searchForm.contains(event.target) && !searchButton.contains(event.target) && siteHeader.classList.contains('search-open')) {
